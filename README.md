...
Given this manifest with a RHEL base and a digest-pinned entitlement fragment carrying an encumbered package:
...
# --- Hooks ---
RUN --mount=type=bind,from=quay.io/your-username/rhel-entitlement@sha256:<digest>,source=/fragment/hook,target=/frag-hook,z \
